...
grid(nx = NA, ny = NULL)
mtext("Temperature", 2, 3, at = 15, las = 0, col = "red")
mtext("[°C]", 2, 2, at = 15, las = 0, col = "red")
mtext("Precipitation", 2, 3, at = 2.5, las = 0, col = "blue")
mtext("[mm/hours]", 2, 2, at = 2.5, las = 0, col = "blue")
